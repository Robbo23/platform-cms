  ...
  async function createPost(siteId) {
    try {
      ...
      if (res.ok) {
        ...
        await router.push(`/post/${data.postId}`);
      }
    } catch (error) {
      console.error(error);
    }
                    ...
                    <div className="flex flex-col md:flex-row md:h-60 rounded-lg overflow-hidden border border-gray-200">
                      ...
                      <div className="relative p-10">
                        ...
                        <a
                          ...
                          href={`https://${data.site?.subdomain}.platform-cms.vercel.app/${post.slug}`}
                          onClick={(e) => e.stopPropagation()}
                          rel="noreferrer"
                          target="_blank">
                          {data.site?.subdomain}.platform-cms.vercel.app/{post.slug} ↗
                        </a>
                      </div>
                    </div>
                  </a>
